package case_study_module_2.furama_resort.utils.validate.validate_input_employee;
...
public class ValidateInputEmployee {
    ...
    public static String validateEmailEmployee() {
        do {
            try {
    ...
    public static String validatePhoneNumberEmployee() {
        do {
            try {
